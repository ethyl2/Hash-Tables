...
class HashTable:
    ...
    def insert(self, key, value):
        ...
        Stretch goal: Update your HashTable to automatically double in size when it grows past a load factor of 0.7
    ...
    def remove(self, key):
        ...
        Stretch: check to see if capacity should be reduced.
        '''
        # Get the hashed_key.
        hashed_key = self._hash_mod(key)
